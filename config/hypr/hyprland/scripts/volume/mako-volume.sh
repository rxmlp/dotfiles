...
case $1 in
    ...
    notify-send --app-name volume -h string:x-canonical-private-synchronous:340716 -i "/usr/share/icons/$theme/symbolic/status/audio-volume-muted-symbolic.svg" "Mute"
	else
	send_notification
	fi
	;;
